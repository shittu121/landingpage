...
const Card2: React.FC<CardProps> = ({ title, content, imageurl }) => {
  return (
    <div className="lg:flex md:flex sm:flex block gap-20 w-[100%] h-[35rem] relative">
      <Image src={imageurl} className="w-[100%] h-[100%] object-cover lg:h-full md:h-[35rem] sm:h-full" width={50} height={50} alt="cardlogo" />
